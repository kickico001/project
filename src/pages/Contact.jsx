      ...
      <div className="flex flex-col min-h-screen">
        <div className="container flex flex-col flex-1 px-6 py-12 mx-auto">
          <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
            <div className="text-white lg:w-1/2 lg:mx-6 hidden lg:block">
              <h1 className="text-2xl font-semibold capitalize lg:text-3xl">
                CardaFlux{" "}
              </h1>

              <p className="max-w-xl mt-6">Be Unlimited - Beyond Limits</p>

              <button className="px-8 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-orange-500 rounded-md hover:bg-orange-500 focus:outline-none focus:ring focus:ring-orange-400 focus:ring-opacity-50">
                get in touch
              </button>
            ...
            <div className="mt-8 lg:w-1/2 lg:mx-6">
              <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-[#3BAA671A] shadow-2xl rounded-xl  lg:max-w-xl">
